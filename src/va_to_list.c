...
#ifdef DEBUG
                  printf("%s[%d] - allocatted %zu@%p\n", __FILE__, __LINE__, sizeof(int), tmp_int);
#endif
...
#ifdef DEBUG
                  printf("%s[%d] - allocatted %zu@%p\n", __FILE__, __LINE__, sizeof(int), tmp_char);
#endif
...
#ifdef DEBUG
                  printf("%s[%d] - allocatted %zu@%p\n", __FILE__, __LINE__, sizeof(int), tmp_double);
#endif
